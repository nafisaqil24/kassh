...
Aplikasi web untuk mencatat uang kas kelompok kecil (6 anggota), menggantikan pencatatan manual di kertas. Dirancang khusus untuk bendahara & wakil bendahara tanpa memerlukan autentikasi login (cukup jaga kerahasiaan URL).

## Tech Stack
- **Frontend**: React + TypeScript + Vite + Tailwind CSS
- **Backend**: Node.js + Express + Prisma ORM
- **Database**: SQLite (file lokal `backend/prisma/dev.db`)
...
2. **Manajemen Anggota**: Tambah dan hapus anggota (dengan 6 seed awal: Danang, Rian, Nayif, Nafis, Alung, Putra).
